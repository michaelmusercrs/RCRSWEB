...
- `[pending]` **9.2 Backfill remaining ~235 historical invoices** — `[needs-owner]` go-ahead. Same pipeline, batch by month, verify inventory deltas don't go absurdly negative on stale tickets. Phase 9.1 scripts re-run cleanly.
