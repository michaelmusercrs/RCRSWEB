...
const SLIDES = [
  {
    ...
    cta: null,
    type: 'title' as const,
    note: 'OPENER (pause, look serious): "Before I start, I have to share something. Last week I was at a county fair and there was a fortune-telling dog. You pay $5, the dog paws at cards and barks out your fortune. So I tried it. The dog looked at me, tilted his head, pawed three cards... and barked one word: ROOF. (pause) I said well boy, you are not wrong. That IS my future." (wait for laugh) --- FUN FACT: Last year, 47 hail storms hit within 10 miles of THIS building. The biggest hailstone ever recorded was 8 inches across in South Dakota - bigger than a volleyball. Alabama holds the world record: 62 tornadoes in 24 hours on April 27, 2011. We are in Dixie Alley, folks.',
  },
  {
    label: 'Free Tool',
    title: ['STORM', 'CHECK'],
  ...
  },
  {
    ...
    cta: { text: 'TRY IT NOW', href: 'https://www.ikoroofing.com/en-us/roofing-tools/roof-visualizer/', blue: true },
    ctaNote: 'Also on our site: rivercityroofingsolutions.com/services',
