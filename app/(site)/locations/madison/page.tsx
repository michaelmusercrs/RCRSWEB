...
// FAQ data for Madison - used for both display and schema
const madisonFAQs = [
  {
    question: 'Do you offer free roof inspections in Madison?',
    answer: 'Yes! We provide free, no-obligation roof inspections for all Madison-area homes. Our certified inspectors will assess your roof\'s condition and provide a detailed report with photos.',
  },
  {
    question: 'How quickly can you respond to storm damage in Madison?',
    answer: 'We offer 24/7 emergency services for storm damage. We can typically have a crew at your Madison property within hours for emergency tarping and temporary repairs.',
  },
  {
  ...
  {
    question: 'What roofing materials do you install in Madison?',
...
export default function MadisonPage() {
  ...
  const faqSchema = generateFAQSchema(madisonFAQs);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Home', url: '/' },
    { name: 'Locations', url: '/service-areas' },
    { name: 'Madison', url: '/locations/madison' },
  ]);
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[50vh] flex items-center text-white">
        <div className="absolute inset-0 z-0">
          <Image src="/uploads/area-madison.jpg" alt="Suburban neighborhood in Madison Alabama - roofing services" fill className="object-cover" priority />
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 px-6 py-12 md:py-16">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter mb-6 leading-tight drop-shadow-lg">
            Madison Roofing Experts
          </h1>
          <p className="text-lg md:text-xl max-w-2xl mx-auto text-white/80 leading-relaxed mb-8">
            Professional roof repair, replacement, and storm damage services in Madison, AL. Free estimates and insurance claim assistance.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-wider mb-4">
              Roofing Services in Madison
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Roof Repair', desc: 'Quick leak repairs and storm damage fixes for Madison homes.' },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-300 text-lg">
              Proudly serving Madison and all of North Alabama
            </p>
          </div>
          <div className="rounded-lg overflow-hidden shadow-xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d105126.23!2d-86.7483!3d34.6993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88626ca7de6f9bd5%3A0x8e6c99c6f05e5e7!2sMadison%2C%20AL!5e0!3m2!1sen!2sus!4v1234567890"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Madison AL Service Area Map"
            ></iframe>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-neutral-800 bg-neutral-950">
              <CardContent className="p-6">
                ...
                <p className="text-neutral-300 italic mb-4">
                  "Excellent service and handled our insurance claim perfectly! Beautiful work on our Madison home."
                </p>
            ...
            <Card className="border-neutral-800 bg-neutral-950">
              <CardContent className="p-6">
                ...
                <p className="text-brand-green font-bold">- Alison C., Madison</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-neutral-800 bg-neutral-950">
              <CardContent className="p-6">
                ...
                <p className="text-neutral-300 italic mb-4">
                  "Rick got our roof replaced through insurance—highly recommend for anyone in the Madison area!"
                </p>
          ...
          <div className="space-y-4">
            <details className="bg-black border border-neutral-800 rounded-lg p-6 group hover:border-brand-green transition-colors">
              <summary className="font-black uppercase tracking-wider cursor-pointer list-none flex justify-between items-center">
                Do you offer free roof inspections in Madison?
                <CheckCircle2 className="h-5 w-5 text-brand-green" />
              </summary>
              <p className="text-neutral-400 mt-4 leading-relaxed">
                Yes! We provide free, no-obligation roof inspections for all Madison-area homes. Our certified inspectors will assess your roof's condition and provide a detailed report with photos.
              </p>
            </details>
            ...
            <details className="bg-black border border-neutral-800 rounded-lg p-6 group hover:border-brand-green transition-colors">
              ...
              <p className="text-neutral-400 mt-4 leading-relaxed">
                We offer 24/7 emergency services for storm damage. We can typically have a crew at your Madison property within hours for emergency tarping and temporary repairs.
              </p>
            </details>
            ...
            <details className="bg-black border border-neutral-800 rounded-lg p-6 group hover:border-brand-green transition-colors">
              <summary className="font-black uppercase tracking-wider cursor-pointer list-none flex justify-between items-center">
                What roofing materials do you install in Madison?
                <CheckCircle2 className="h-5 w-5 text-brand-green" />
              </summary>
              <p className="text-neutral-400 mt-4 leading-relaxed">
      ...
      <section className="py-12 md:py-16 px-6 bg-brand-green text-black border-t border-neutral-800">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-black uppercase tracking-wider mb-4 leading-tight">
            Ready for Your Free Madison Roof Estimate?
          </h2>
