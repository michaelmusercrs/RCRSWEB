...
// FAQ data for Decatur - used for both display and schema
const decaturFAQs = [
  {
    question: 'Do you offer free roof inspections in Decatur?',
    answer: 'Yes! We provide free, no-obligation roof inspections for all Decatur-area homes. Our certified inspectors will assess your roof\'s condition and provide a detailed report with photos.',
  },
  {
    question: 'How quickly can you respond to storm damage in Decatur?',
    answer: 'We offer 24/7 emergency services for storm damage. We can typically have a crew at your Decatur property within hours for emergency tarping and temporary repairs.',
  },
  {
  ...
  {
    question: 'What roofing materials do you install in Decatur?',
...
export default function DecaturPage() {
  ...
  const faqSchema = generateFAQSchema(decaturFAQs);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Home', url: '/' },
    { name: 'Locations', url: '/service-areas' },
    { name: 'Decatur', url: '/locations/decatur' },
  ]);
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[50vh] flex items-center text-white">
        <div className="absolute inset-0 z-0">
          <Image src="/uploads/area-decatur.jpg" alt="Tennessee River bridge in Decatur Alabama - roofing services" fill className="object-cover" priority />
            ...
            <Card className="border-neutral-800 bg-neutral-950">
              <CardContent className="p-6">
                ...
                <p className="text-neutral-300 italic mb-4">
                  "River City Roofing did a fantastic job on our roof replacement. Quick, professional, and the cleanup was spotless. Highly recommend for anyone in Decatur!"
                </p>
                <p className="text-brand-green font-bold">- KT, Decatur</p>
              </CardContent>
            </Card>
