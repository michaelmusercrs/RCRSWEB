      ...
      <section className="py-16 md:py-24 px-6 bg-neutral-950 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-block mb-4">
              <span className="text-xs uppercase tracking-widest font-bold text-lime-400">Major Expansion</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-lime-400 bg-black">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-black uppercase tracking-wider mb-3 text-lime-400">2026</h3>
                <p className="text-neutral-400">Official Nashville launch date</p>
              </CardContent>
            </Card>
            <Card className="border-neutral-800 bg-black">
              <CardContent className="p-8 text-center">
                <Music className="h-16 w-16 mx-auto mb-4 text-lime-400" />
            ...
            <Card className="border-neutral-800 bg-black">
              <CardContent className="p-8 text-center">
                <TrendingUp className="h-16 w-16 mx-auto mb-4 text-lime-400" />
