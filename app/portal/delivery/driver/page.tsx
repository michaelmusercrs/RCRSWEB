...
const MOCK_NOTIFICATIONS = [
  { id: '1', message: 'Henderson delivery assigned to you for 8:30 AM', time: '6:45 AM', priority: 'normal' as const, read: false },
  { id: '2', message: 'RUSH: Whitfield Insurance repair added for 11:00 AM', time: '7:00 AM', priority: 'high' as const, read: false },
  { id: '3', message: 'Thompson Gutter job confirmed for 2:00 PM', time: '7:15 AM', priority: 'normal' as const, read: true },
];
