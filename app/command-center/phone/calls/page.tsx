  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 md:p-10">
      <div className="max-w-2xl mx-auto text-center py-20">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Call Log</h1>
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-10 max-w-md mx-auto">
          View call history, listen to recordings, and track call metrics. Filter by date, extension, or call type.
        </p>
        <Link
