        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-300 text-lg">
              Proudly serving Madison, Madison, and all of North Alabama
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-neutral-800 bg-neutral-950">
              <CardContent className="p-6">
                <div className="flex mb-4">
                  {[...Array(5)].map((_, i) => (
                    <span key={i} className="text-lime-400 text-xl">★</span>
                  ))}
                </div>
                ...
                <p className="text-lime-400 font-bold">- JS, Madison</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-neutral-800 bg-neutral-950">
              <CardContent className="p-6">
                ...
                <p className="text-lime-400 font-bold">- Alison C., Madison</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-neutral-800 bg-neutral-950">
              <CardContent className="p-6">
                ...
                <p className="text-lime-400 font-bold">- Local Homeowner</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 px-6 bg-neutral-950 border-t border-neutral-800">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            <details className="bg-black border border-neutral-800 rounded-lg p-6 group hover:border-lime-400 transition-colors">
