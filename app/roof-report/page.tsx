...
interface RoofReport {
  ...
  qualityNotes: string[];
  images: { satellite: string; satelliteZooms?: string[]; streetView: string[] };
          ...
          {r && (
            <div className="space-y-6">
              ...
              <div className="print-only hidden mb-8">
                <div className="flex items-center gap-4 pb-4 border-b-2 border-emerald-500">
                  <Image src="/logo-transparent.png" alt="RCRS" width={56} height={56} />
                  <div>
                    <h1 className="text-2xl font-bold text-black">ROOF MEASUREMENT REPORT</h1>
                    <p className="text-sm text-zinc-600">River City Roofing Solutions · AI-Powered Satellite Analysis</p>
                  </div>
                  <div className="ml-auto text-right text-sm text-zinc-600">
                    <p>(256) 274-8530</p>
                    <p>rivercityroofingsolutions.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="print-only hidden">
                <div className="mt-8 pt-4 border-t-2 border-zinc-300 text-center text-xs text-zinc-600">
                  <p className="font-semibold">River City Roofing Solutions</p>
                  <p>(256) 274-8530 · rivercityroofingsolutions.com · info@rcrsal.com</p>
                  <p className="mt-1">Report generated {new Date(r.generatedAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
                  <p className="mt-1 italic">This report is an AI-generated estimate. On-site verification recommended.</p>
                </div>
              </div>
            </div>
          )}
