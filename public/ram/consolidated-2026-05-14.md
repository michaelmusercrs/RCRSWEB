...
> 4 new `.cds` recordings + 2 new `.csv` exports pulled 5/19-5/20 post-coil-swap. Bank 2 LTFT mean dropped +6.60% → +1.06%. Banks now symmetric. Cyl 8 FTP counter 0.20 → 0.00. Verified under load (MAF to 150.74 g/s). Files: `CHRYSLER_1779201849443.cds`, `CHRYSLER_1779202299949.cds`, `CHRYSLER_1779208448837.cds`, `CHRYSLER_1779209263587.cds`, `CHRYSLER_1779202189986_1779202220076.csv`, `CHRYSLER_1779202324364_1779202485164.csv`.

**Vehicle:** 2013 Ram 1500, 5.7L HEMI V8 with MDS — PCM odometer **319,774 mi**  
**Capture dates:** 2026-05-14 baseline · 2026-05-19 follow-up (XTOOL D7, serial D7-027522)  
**Symptoms reported:** loss of power, oil pressure light, small vibration at idle (loss-of-power + vibration resolved 5/19)  
**Source:** 6 `.cds` + 3 `.csv` from 5/14 baseline plus 4 `.cds` + 2 `.csv` from 5/19 follow-up. The two 2004 Dodge captures from the same baseline session are excluded.
