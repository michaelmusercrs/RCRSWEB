...
const ROLE_LESSON_MODULES: TrainingModuleDef[] = [
  ...
  {
    id: 'lesson-sara-inventory-2026',
    title: 'Inventory & the Warehouse Flow',
    description:
      'How stock moves: auto-deduction at Mark Loaded, fixing mis-clicks safely (Fix status + Undo verify-load), low-stock alerts, and the self-check scanner that reconciles order↔ticket↔invoice↔breakdown↔inventory.',
    role: 'admin',
    additionalRoles: ['office_staff'],
    estimatedMinutes: 25,
    status: 'ready',
    category: 'Sara Deep Dives',
    order: 1,
    contentType: 'lesson',
    contentUrl: '/portal/training/lesson/sara-inventory',
    icon: 'package',
  },
  {
    id: 'lesson-sara-users-2026',
    title: 'Users, Roles & Team Management',
    description:
      'Managing accounts at /portal/admin/users: roles vs granular permissions, activate/deactivate, credential resets, the login/onboarding flow, profile-change approvals, and who can see cost.',
    role: 'admin',
    additionalRoles: ['office_staff'],
    estimatedMinutes: 20,
    status: 'ready',
    ...
    order: 2,
    contentType: 'lesson',
    contentUrl: '/portal/training/lesson/sara-users',
    icon: 'users',
  },
  {
    id: 'lesson-sara-phone-2026',
    title: 'Phone System (Rolling Out)',
    description:
      'A preview of the phone system coming to the portal: call log + secure recordings, voicemail transcription (voicemail only — NOT live-call summaries), who-sees-what scoping, and Sara\'s feature codes.',
    role: 'admin',
    additionalRoles: ['office_staff'],
    estimatedMinutes: 20,
    status: 'ready',
    ...
    order: 3,
    contentType: 'lesson',
    contentUrl: '/portal/training/lesson/sara-phone',
    icon: 'phone',
  },
  {
