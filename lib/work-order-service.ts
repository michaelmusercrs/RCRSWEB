  ...
  return [
    {
      ...
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: twoDaysAgo + 'T14:30:00Z', changedBy: 'Sarah Mitchell' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: yesterday + 'T09:15:00Z', changedBy: 'Mike Torres' },
      ],
    },
    {
      ...
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: threeDaysAgo + 'T10:00:00Z', changedBy: 'Mike Torres' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: threeDaysAgo + 'T11:30:00Z', changedBy: 'Sarah Mitchell' },
    ...
    },
    {
      ...
      specialInstructions: 'URGENT: Crew on site waiting. Call foreman Jake at (256) 555-0301 on arrival.',
      assignedDriver: 'Carlos Rivera',
      vehicleType: 'Pickup w/ Trailer',
      status: 'scheduled',
      createdAt: today + 'T08:30:00Z',
      updatedAt: today + 'T09:00:00Z',
      createdBy: 'Jake Hernandez',
      estimatedCost: 626,
      actualCost: null,
      photos: ['rot-damage-1.jpg', 'rot-damage-2.jpg'],
      documents: [],
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: today + 'T08:30:00Z', changedBy: 'Jake Hernandez' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: today + 'T08:45:00Z', changedBy: 'Mike Torres', notes: 'Urgent supplement approved' },
    ...
    },
    {
      ...
      documents: [],
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: yesterday + 'T16:00:00Z', changedBy: 'Sarah Mitchell' },
      ],
    },
    {
      ...
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: twoDaysAgo + 'T11:00:00Z', changedBy: 'Mike Torres' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: yesterday + 'T14:00:00Z', changedBy: 'Sarah Mitchell' },
      ],
    },
    {
      ...
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: threeDaysAgo + 'T09:00:00Z', changedBy: 'Sarah Mitchell' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: threeDaysAgo + 'T10:00:00Z', changedBy: 'Mike Torres' },
    ...
    },
    {
      ...
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: twoDaysAgo + 'T16:00:00Z', changedBy: 'Mike Torres' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: yesterday + 'T08:00:00Z', changedBy: 'Sarah Mitchell' },
    ...
    },
    {
      ...
      documents: [],
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: yesterday + 'T10:00:00Z', changedBy: 'Sarah Mitchell' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: today + 'T08:00:00Z', changedBy: 'Mike Torres' },
      ],
    },
    {
      ...
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: new Date(now.getTime() - 5 * 86400000).toISOString().slice(0, 10) + 'T09:00:00Z', changedBy: 'Mike Torres' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: new Date(now.getTime() - 4 * 86400000).toISOString().slice(0, 10) + 'T08:00:00Z', changedBy: 'Sarah Mitchell' },
    ...
    },
    {
      ...
      specialInstructions: 'Deliver to crew on site. Foreman: Ray Johnson.',
      assignedDriver: 'Marcus Johnson',
      vehicleType: 'Flatbed Truck',
      status: 'completed',
      createdAt: yesterday + 'T09:30:00Z',
      updatedAt: yesterday + 'T12:00:00Z',
      createdBy: 'Ray Johnson',
      estimatedCost: 721,
      actualCost: 721,
      photos: ['supplement-delivered.jpg'],
      documents: [],
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: yesterday + 'T09:30:00Z', changedBy: 'Ray Johnson' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: yesterday + 'T09:45:00Z', changedBy: 'Mike Torres', notes: 'Rush supplement approved' },
    ...
    },
    {
      ...
      documents: [],
      statusHistory: [
        { from: 'draft' as WorkOrderStatus, to: 'submitted', changedAt: new Date(now.getTime() - 8 * 86400000).toISOString().slice(0, 10) + 'T14:00:00Z', changedBy: 'Sarah Mitchell' },
        { from: 'submitted' as WorkOrderStatus, to: 'approved', changedAt: new Date(now.getTime() - 7 * 86400000).toISOString().slice(0, 10) + 'T09:00:00Z', changedBy: 'Mike Torres' },
        { from: 'approved' as WorkOrderStatus, to: 'cancelled', changedAt: new Date(now.getTime() - 6 * 86400000).toISOString().slice(0, 10) + 'T16:00:00Z', changedBy: 'Sarah Mitchell', notes: 'Customer postponed project to spring' },
      ],
    },
  ];
}
...
"John Smith","(256) 555-0100","jsmith@email.com","123 Main St","Huntsville","AL","35801","delivery","normal","Architectural Shingles",30,"bundle",95,"Standard delivery"
"Jane Doe","(256) 555-0200","jdoe@email.com","456 Oak Ave","Madison","AL","35758","delivery","rush","3-Tab Shingles",25,"bundle",75,"Rush order - storm damage"`;
  }
}
