...
const UNIFIED_CATALOG: Omit<InventoryItem, 'availableQty'>[] = [
  ...
  { productId: 'INV-0002', legacyId: 'item-124', legacySku: 'CAP-PLST', productName: 'Bottom Caps (plastic)', description: '25-35 SQ per bucket by pitch', category: 'nails_fasteners', sku: 'CAP-PLST', unit: 'bag', currentQty: 0, holdQty: 0, minStockLevel: 20, maxStockLevel: 200, reorderQty: 50, unitCost: 16.50, unitPrice: 29.15, supplier: '', supplierPartNumber: '', location: 'Warehouse', weight: 15, lastCountDate: '', lastCountBy: '', lastRestockDate: '', notes: '', active: true },
